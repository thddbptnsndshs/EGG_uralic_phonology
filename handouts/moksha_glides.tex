...
\end{minipage}
	...
	Sources of data: chapter on Moksha phonology by \citeay{kukhto2018}, chapter on Moksha morphophonology by \citeay{kozlov2018}, the \href{http://moksha.web-corpora.net}{Moksha corpus} and online fieldwork. A practical transcription adopted from \citeay{toldovaetal2018} is used throughout the paper; the IPA correspondence table is provided in the appendix.
...
\end{minipage}	
	...
	\noindent Such are the /u i/-initial suffixes: while alternating between vowels and glides like the bases that are subject to glide insertion, the latter diverge from the former in their underlying representation: glide insertion happens to base-final vowels (/u i/), but the vowel-glide alternation happens to suffix-initial consonants (/v j/). One may wonder whether glides are really absent from the representations of the bases subject to glide epenthesis, from which comes a possible objection to my account of this phenomenon.
